...
import { LinkInput } from "@/components/common/forms";

const STORAGE_KEY = "add_profile_creator_details";
...
interface CreatorDetailsFormData {
  location: string;
  niche: string;
  specialties: string[];
  socialLinks: {
...
export default function CreatorDetailsPage() {
  ...
  const [formData, setFormData] = useState<CreatorDetailsFormData>({
    location: "",
    niche: "",
    specialties: [],
    socialLinks: {},
  ...
  const isFormValid = Boolean(formData.location && formData.niche);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Convert socialLinks to the format expected by the database
      ...
      // Add creator details to the profile data
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              What specific areas do you specialize in? (e.g. makeup tutorials,
              mobile gaming)
            </p>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <LinkInput
                  ...
                  onChange={(url: string) => updateSocialLink("other", url)}
          ...
          <div>
            ...
            />
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              Add tags to help people find your content (e.g. tutorials, vlogs,
              comedy)
            </p>
          </div>
